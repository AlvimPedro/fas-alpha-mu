...
figure(1)
loglog(N_ports,squeeze(Po(1,:,1,1,1)),'-g',...
       N_ports,squeeze(Po(1,:,1,2,1)),'-b',...
       N_ports,squeeze(Po(1,:,1,1,2)),'-g',...
       N_ports,squeeze(Po(1,:,1,2,2)),'-b',...
       N_ports,squeeze(Po(1,:,1,1,3)),'-g',...
       N_ports,squeeze(Po(1,:,1,2,3)),'-b'); hold on
